...
import static com.meetkiki.blog.constants.TaleConst.SQL_QUERY_ARTICLES;
...
public class ContentsService {
    ...
    public Page<Contents> findArticles(ArticleParam articleParam) {
        ...
        if (StringUtils.hasText(articleParam.getStatus())) {
            query.and(Contents::getStatus, articleParam.getStatus());
        }

        if (StringUtils.hasText(articleParam.getTitle())) {
            query.and(Contents::getTitle).like("%" + articleParam.getTitle() + "%");
        }

        if (StringUtils.hasText(articleParam.getCategories())) {
    ...
    private Contents mapContent(Contents contents) {
        if (StringUtils.hasText(contents.getSlug())) {
