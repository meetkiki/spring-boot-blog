...
public final class Commons {
    ...
    public static boolean is_empty(Page<?> paginator) {
        return null == paginator || CollectionUtils.isEmpty(paginator.getRows());
    }
    ...
    public static String fmtdate(Date date, String fmt) {
        return DateUtils.toString(date, fmt);
    }
    ...
    public static String fmtdate(Integer unixTime, String patten) {
        if (null != unixTime && StringUtils.hasText(patten)) {
            return DateUtils.toString(unixTime, patten);
        }
        return "";
    }
